...
public class MenuMethode1 implements ApplicationListener{
       ...
       public void create() {
             ...
             boutonSprite =new Sprite(new Texture("button/button.png")) ;
             boutonCliqueSprite = new Sprite(new Texture("button/butonclique.png")) ;
             arrierePlanSprite = new Sprite(new Texture("button/arriereplan.png"));
             boutonRetourSprite = new Sprite(new Texture("button/retour.png"));
